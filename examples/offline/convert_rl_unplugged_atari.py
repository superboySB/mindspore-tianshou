...
def _decode_frames(pngs: tf.Tensor) -> tf.Tensor:
    ...
    # NOTE: to match mindrl's convention for framestacking
...
def _tf_example_to_tianshou_batch(tf_example: tf.train.Example) -> Batch:
    """Create a mindrl Batch replay sample from a TF example."""
    ...
    # Build mindrl Batch replay sample.
