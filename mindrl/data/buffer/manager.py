...
from mindrl.data import Batch, HERReplayBuffer, PrioritizedReplayBuffer, ReplayBuffer
from mindrl.data.batch import _alloc_by_keys_diff, _create_value
...
class ReplayBufferManager(ReplayBuffer):
    ...
    .. seealso::
        ...
        Please refer to :class:`~mindrl.data.ReplayBuffer` for other APIs' usage.
    """
