...
from mindrl.data.batch import _alloc_by_keys_diff
from mindrl.env import BaseVectorEnv, DummyVectorEnv
...
class Collector(object):
    ...
    :param policy: an instance of the :class:`~mindrl.policy.BasePolicy` class.
    :param env: a ``gym.Env`` environment or an instance of the
        :class:`~mindrl.env.BaseVectorEnv` class.
    :param buffer: an instance of the :class:`~mindrl.data.ReplayBuffer` class.
    ...
    "policy" and "env_id".
    It returns either a dict or a :class:`~mindrl.data.Batch` with the modified
...
class AsyncCollector(Collector):
    ...
    The arguments are exactly the same as :class:`~mindrl.data.Collector`, please
    refer to :class:`~mindrl.data.Collector` for more detailed explanation.
    """
