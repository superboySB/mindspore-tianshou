...
from mindrl.policy import SACPolicy
from mindrl.utils.net.continuous import ActorProb
...
class CQLPolicy(SACPolicy):
    ...
    :param ActorProb actor: the actor network following the rules in
        :class:`~mindrl.policy.BasePolicy`. (s -> a)
    ...
    def learn(self, batch: Batch, **kwargs: Any) -> Dict[str, float]:
        batch: Batch = to_mindspore(batch, dtype=torch.float, device=self.device)
