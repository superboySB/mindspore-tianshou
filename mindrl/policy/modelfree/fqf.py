...
from mindrl.data import Batch, ReplayBuffer, to_numpy
from mindrl.policy import DQNPolicy, QRDQNPolicy
from mindrl.utils.net.discrete import FractionProposalNetwork, FullQuantileFunction
...
class FQFPolicy(QRDQNPolicy):
    ...
    .. seealso::
        ...
        Please refer to :class:`~mindrl.policy.QRDQNPolicy` for more detailed
        explanation.
    """
