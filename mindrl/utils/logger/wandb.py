...
from mindrl.utils import BaseLogger, TensorboardLogger
from mindrl.utils.logger.base import LOG_DATA_TYPE
...
class WandbLogger(BaseLogger):
    ...
    :param str project: W&B project name. Default to "mindrl".
    ...
    def __init__(
        ...
        self.restored = False
        if project is None:
            project = os.getenv("WANDB_PROJECT", "mindrl")
        ...
        self.wandb_run._label(repo="mindrl")  # type: ignore
