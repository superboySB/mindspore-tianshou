...
from mindrl.data import Batch, Collector
from mindrl.env import BaseVectorEnv, DummyVectorEnv, SubprocVectorEnv
...
class FiniteVectorEnv(BaseVectorEnv):
    ...
    # to workaround with mindrl's buffer and batch
